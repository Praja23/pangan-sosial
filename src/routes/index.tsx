  ...
  head: () => ({
    meta: [
      { title: "PanganPeduli — Selamatkan Makanan, Bantu Sesama" },
      {
        name: "description",
        content:
          "Platform distribusi makanan surplus nasional yang menghubungkan hotel, restoran, UMKM, dan Program MBG dengan masyarakat yang membutuhkan.",
      },
      { property: "og:title", content: "PanganPeduli — Satu Porsi, Satu Kepedulian" },
      {
        property: "og:description",
        content:
          "Selamatkan makanan, bantu sesama. Bergabunglah dengan gerakan food rescue nasional.",
      },
    ],
  }),
  component: Landing,
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-12 items-center">
        <div className="animate-fade-up">
          ...
          <p className="mt-6 text-lg text-muted-foreground max-w-xl leading-relaxed">
            PanganPeduli menghubungkan makanan surplus dari hotel, restoran, UMKM, dan Program MBG
            kepada masyarakat agar tidak terbuang sia-sia. Satu porsi, satu kepedulian.
          </p>
          ...
          <div className="mt-10 flex items-center gap-6 text-sm text-muted-foreground">
            <div className="flex -space-x-3">
              {[
                ...
                <div
                  key={i}
                  className="w-10 h-10 rounded-full border-2 border-background overflow-hidden shadow-soft hover:scale-110 hover:z-10 transition-transform"
                >
                  <img
                    src={p.src}
                    alt={p.alt}
            ...
            <div>
              ...
              <p className="mt-0.5">
                <span className="font-semibold text-foreground">12.847+</span> mitra aktif
              </p>
            </div>
          </div>
        </div>
        <div className="relative animate-scale-in">
          <div className="relative aspect-square max-w-xl mx-auto">
            ...
            <img
              src={heroImg}
              alt="Ilustrasi distribusi makanan PanganPeduli"
              className="relative w-full h-full object-contain animate-float"
            />
            <FloatCard
              className="absolute top-8 -left-2 sm:left-4 animate-float-slow"
              icon={<Leaf className="w-4 h-4 text-success" />}
              title="2,4 kg"
              subtitle="CO₂ diselamatkan"
            />
            <FloatCard
              className="absolute bottom-16 -right-2 sm:right-4"
              style={{ animation: "float 7s ease-in-out infinite" }}
              icon={<Users className="w-4 h-4 text-primary" />}
              title="127 orang"
              subtitle="Terbantu hari ini"
            />
            <FloatCard
...
function FloatCard({
  ...
  return (
    <div
      className={`glass-card rounded-2xl px-4 py-3 shadow-float flex items-center gap-3 min-w-[160px] ${className}`}
      style={style}
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-2xl mb-16">
          ...
          <h2 className="mt-2 font-display text-4xl sm:text-5xl font-bold">
            Dari Surplus Menjadi <span className="text-gradient">Berkah</span>.
          </h2>
          <p className="mt-4 text-lg text-muted-foreground">
            Empat langkah sederhana untuk mengubah makanan yang akan terbuang menjadi solusi sosial
            nyata.
          </p>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {steps.map((s, i) => (
            <Reveal key={i} delay={i * 100}>
              <div
                className="relative glass-card rounded-2xl p-6 hover-lift tilt-card h-full magnetic-glow"
                onMouseMove={(e) => {
...
// ─── PERBAIKAN: Categories dengan grid responsif dan tinggi otomatis ───
function Categories() {
  const cats = [
    {
      to: "/kategori/mbg",
    ...
    <section id="kategori" className="py-20 lg:py-32 bg-secondary/30">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="mt-2 font-display text-4xl sm:text-5xl font-bold">
            Ekosistem yang <span className="text-gradient">Terhubung</span>
          </h2>
          <p className="mt-3 text-muted-foreground">
            Klik kategori untuk melihat daftar mitra dan menu surplus yang tersedia.
          </p>
        </div>
        {/* PERBAIKAN: grid responsif, auto-rows-min, dan min-h pada kartu */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:grid-rows-2 gap-4 sm:gap-6 auto-rows-min">
          {cats.map((c, i) => (
            <Link
              key={i}
              to={c.to}
              className={`group glass-card rounded-3xl p-6 sm:p-8 hover-lift relative overflow-hidden flex flex-col justify-between min-h-[200px] sm:min-h-[220px] ${c.className || ""}`}
            >
              ...
              <div className="relative h-full flex flex-col">
                ...
                <div className="mt-auto pt-6 flex items-center justify-between text-sm">
                  <div>
                    ...
                    <span className="text-muted-foreground ml-1">mitra</span>
                  </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            Sistem penilaian cerdas yang menghitung tingkat kontribusi penyelamatan makanan dan
            dampak sosial dari setiap unggahan, pengguna, dan mitra — secara real-time dan
            transparan.
          </p>
          ...
          <div className="glass-card rounded-[2.5rem] p-8 shadow-float">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-center">
              <div className="p-3 rounded-xl bg-secondary">
                <div className="font-display font-bold">5kg</div>
                <div className="text-[10px] text-muted-foreground">Dicegah</div>
              </div>
              <div className="p-3 rounded-xl bg-secondary">
                <div className="font-display font-bold">12kg</div>
                <div className="text-[10px] text-muted-foreground">CO₂ saved</div>
              </div>
              <div className="p-3 rounded-xl bg-secondary">
                <div className="font-display font-bold">38</div>
                <div className="text-[10px] text-muted-foreground">Porsi</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <section id="impact" className="pt-20 pb-10 lg:pt-28 lg:pb-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="max-w-2xl mb-16">
          ...
          <h2 className="mt-2 font-display text-4xl sm:text-5xl font-bold">
            Semua yang Dibutuhkan untuk <span className="text-gradient">Food Rescue</span>
          </h2>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <p className="mt-5 text-lg text-primary-foreground/90 max-w-xl">
              Mulai selamatkan makanan hari ini. Setiap porsi yang kita selamatkan adalah satu
              langkah menuju Indonesia tanpa food waste.
            </p>

            <div className="mt-8 flex flex-wrap justify-center gap-3">
              <Link
                to="/cari"
                className="inline-flex items-center gap-2 px-7 py-4 rounded-xl bg-background text-foreground font-semibold shadow-float hover:scale-105 transition-transform"
              >
              ...
              <Link
                to="/auth"
                search={{ mode: "register" }}
                className="px-7 py-4 rounded-xl bg-primary-foreground/15 backdrop-blur border border-primary-foreground/30 text-primary-foreground font-semibold hover:bg-primary-foreground/25 transition-colors"
              >
                Daftar Sebagai Mitra
              </Link>
            </div>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-2 text-xs">
              {[
                ...
                <Link
                  key={c.to}
                  to={c.to}
                  className="px-3 py-1.5 rounded-full bg-primary-foreground/15 backdrop-blur text-primary-foreground hover:bg-primary-foreground/25 transition"
                >
                  {c.label}
                </Link>
              ))}
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <Reveal>
          <div className="text-center mb-12">
            ...
            <p className="mt-3 text-muted-foreground">
              Belum menemukan jawaban? Hubungi tim mitra kami.
            </p>
          </div>
        </Reveal>
              ...
              <Reveal key={i} delay={i * 60}>
                ...
                >
                  ...
                  >
                    ...
                    <span
                      className="shrink-0 grid place-items-center w-8 h-8 rounded-full bg-[image:var(--gradient-warm)] text-primary-foreground transition-transform duration-300"
